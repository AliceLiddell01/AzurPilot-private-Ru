"""Presentation-neutral query model for the Fleet WebUI page."""
...
def _slot_view(slot: FormationFleetSlotObservation) -> FleetSlotViewModel:
    ...
    else:  # Domain validation should make this unreachable.
...
class FleetPageQueryService:
    """Loads all six fleets and latest command in one application transaction."""
