"""Сборщик ключей данных, автоматически собирает ключи данных в архивах кампаний.

Проверяет количество ключей через OCR и определяет необходимость их сбора.
"""
...
class DataKey(UI):
    ...
    def data_key_collect(self):
        """Выполнить сбор ключей данных.

        Returns:
            bool: Был ли выполнен сбор.
