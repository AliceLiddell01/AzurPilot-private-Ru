"""Обработчик наборов снабжения: автоматическая покупка еженедельных и ежедневных наборов.

Определяет доступные типы наборов снабжения по дню недели и времени сервера.
"""
