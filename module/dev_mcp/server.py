...
def tool_definitions() -> list[Tool]:
    ...
    descriptions = {
        ...
        "dev_list_game_observation_capabilities": "Получить каталог target-bound game observation capabilities только для чтения.",
        "dev_get_game_observation": "Получить bounded typed observation назначенного game target через application bridge.",
        "dev_capture_smoke_game_checkpoint": "Сохранить объявленный intermediate game checkpoint конкретного SmokeRun.",
        "dev_get_smoke_game_observations": "Получить bounded game observations конкретного SmokeRun и их completeness.",
        "dev_get_database_status": "Получить сводку developer-only фиксированных PostgreSQL diagnostics.",
        "dev_list_database_checks": "Получить каталог разрешённых read-only PostgreSQL diagnostics.",
        "dev_run_database_check": "Запустить один разрешённый read-only PostgreSQL diagnostic check.",
        "dev_list_database_repairs": "Получить каталог зарегистрированных безопасных database repairs.",
        "dev_preview_database_repair": "Проверить наличие зарегистрированного database repair без его выполнения.",
