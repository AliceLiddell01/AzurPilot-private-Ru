"""
Модуль получения алмазов через срочные заказы.

Автоматизирует получение алмазов, циклически проходя простые этапы ради запуска срочных заказов
(Emergency Commission). Основные возможности:
...
получение алмазов за выполнение срочных заказов.
