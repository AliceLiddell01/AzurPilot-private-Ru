"""Модуль зачистки засад 1-1 для экономной прокачки и фарма алмазов.
Наследует логику GemsFarming и переопределяет стратегию смены флагмана
для поддержки автоматического заполнения и ротации всех трёх слотов основного флота."""
