...
class CampaignRun(CampaignEvent, ShopStatus):
    ...
    def handle_stage_name(self, name, folder, mode='normal'):
        ...
        if folder in [
            ...
            'event_20251023_cn', 'event_20260326_cn', 'war_archives_20230525_cn',
        ...
        if folder in [
            'event_20200917_cn', 'event_20221124_cn', 'event_20230525_cn',
            'war_archives_20200917_cn', 'event_20211125_cn', 'event_20231026_cn',
            'event_20231123_cn', 'event_20240725_cn', 'event_20240829_cn',
            'event_20241024_cn', 'event_20241121_cn', 'event_20250424_cn',
            'event_20250724_cn', 'event_20250814_cn', 'event_20251023_cn',
            'event_20260326_cn', 'war_archives_20230525_cn',
            'war_archives_20231026_cn', 'war_archives_20240725_cn',
        ]:
            name = convert.get(name, name)
        else:
        ...
        if folder == 'event_20240912_cn':
            if self.config.StopCondition_MapAchievement == 'threat_safe':
                logger.info('В событии event_20240912_cn значение MapAchievement=threat_safe заменено на map_3_stars')
            ...
            if self.config.StopCondition_MapAchievement == 'threat_safe_without_3_stars':
                logger.info('В событии event_20240912_cn значение MapAchievement=threat_safe_without_3_stars заменено на 100_percent_clear')
    ...
    def run(self, name, folder='campaign_main', mode='normal', total=0):
        ...
        generated_module = self._resolve_generated_campaign_module(folder, requested_name)
        if generated_module is None:
