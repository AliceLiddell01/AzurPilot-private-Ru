...
TEMPLATE_GAME_SETTINGS_CONTROL_SELECTED = Template(file='./assets/en/game_settings/TEMPLATE_GAME_SETTINGS_CONTROL_SELECTED.png')
TEMPLATE_GAME_SETTINGS_CONTROL_UNSELECTED = Template(file='./assets/en/game_settings/TEMPLATE_GAME_SETTINGS_CONTROL_UNSELECTED.png')
TEMPLATE_GAME_SETTINGS_CUSTOM_SHIP_NAMES_OFF_STATE = Template(file='./assets/en/game_settings/TEMPLATE_GAME_SETTINGS_CUSTOM_SHIP_NAMES_OFF_STATE.png')
