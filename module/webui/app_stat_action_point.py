        ...
        if coins_timeline and chart_points and current_view in ("line", "detail"):
            ...
            if coins_raw_points:
                ...
                if valid_yellow_coins:
                    ...
                    stats_html += f'<div style="display:grid; grid-template-columns:150px 100px 90px 90px 90px; gap:8px; margin-bottom:2px; font-size:12px; color:#aaa;"><span>Жёлтые монеты: <b style="color:#ffd54f">{yc_cur}</b></span><span>Изменение: <b style="color:{yc_change_color}">{yc_change_sign}{yc_change}</b></span><span>Максимум: <b style="color:#ef5350">{yc_max}</b></span><span>Минимум: <b style="color:#26a69a">{yc_min}</b></span><span></span></div>'
                    legend_html += '<span class="ap-legend-item" data-series="2" style="display:flex; align-items:center; gap:4px;cursor:pointer;opacity:1;"><span style="width:12px; height:2px; background:#ffd54f; border-radius:1px; border-top:1px dashed #ffd54f;"></span>Жёлтые монеты</span>'
                ...
                if valid_purple_coins:
                    ...
                    stats_html += f'<div style="display:grid; grid-template-columns:150px 100px 90px 90px 90px; gap:8px; margin-bottom:2px; font-size:12px; color:#aaa;"><span>Фиолетовые монеты: <b style="color:#ce93d8">{pc_cur}</b></span><span>Изменение: <b style="color:{pc_change_color}">{pc_change_sign}{pc_change}</b></span><span>Максимум: <b style="color:#ef5350">{pc_max}</b></span><span>Минимум: <b style="color:#26a69a">{pc_min}</b></span><span></span></div>'
                    legend_html += '<span class="ap-legend-item" data-series="1" style="display:flex; align-items:center; gap:4px;cursor:pointer;opacity:1;"><span style="width:12px; height:2px; background:#ce93d8; border-radius:1px; border-top:1px dashed #ce93d8;"></span>Фиолетовые монеты</span>'
        ...
        if distance_raw_points and chart_points and current_view in ("line", "detail"):
            ...
            if distance_list:
                ...
                if valid_distance:
                    ...
                    stats_html += f'<div style="display:grid; grid-template-columns:150px 100px 90px 90px 90px; gap:8px; margin-bottom:2px; font-size:12px; color:#aaa;"><span>Морские мили: <b style="color:#1565c0">{d_cur}</b></span><span>Изменение: <b style="color:{d_change_color}">{d_change_sign}{d_change}</b></span><span>Максимум: <b style="color:#ef5350">{d_max}</b></span><span>Минимум: <b style="color:#26a69a">{d_min}</b></span><span></span></div>'
                    legend_html += '<span class="ap-legend-item" data-series="4" style="display:flex; align-items:center; gap:4px;cursor:pointer;opacity:1;"><span style="width:12px; height:2px; background:#1565c0; border-radius:1px;"></span>Морские мили</span>'
    ...
    def _build_ap_chart_asset_data(self, asset_timeline, current_view):
        ...
        if asset_list:
            ...
            if valid_asset:
                ...
                stats_html += f'<div style="display:grid; grid-template-columns:150px 100px 90px 90px 90px; gap:8px; margin-bottom:2px; font-size:12px; color:#aaa;"><span>Ресурсы: <b style="color:#22d3ee">{a_cur:.1f}</b></span><span>Изменение: <b style="color:{a_change_color}">{a_change_sign}{a_change:.1f}</b></span><span>Максимум: <b style="color:#ef5350">{a_max:.1f}</b></span><span>Минимум: <b style="color:#26a69a">{a_min:.1f}</b></span><span></span></div>'
                legend_html += '<span class="ap-legend-item" data-series="3" style="display:flex; align-items:center; gap:4px;cursor:pointer;opacity:1;"><span style="width:12px; height:2px; background:#22d3ee; border-radius:1px;"></span>Ресурсы</span>'
