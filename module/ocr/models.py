...
class OcrModel:
    ...
    @cached_property
    def cnocr(self):
        """Совместимость legacy-вызовов через английскую модель Azur Lane.
        ...
        удалённые китайские веса, а направляется на модель ``azur_lane``,
        доступную как через ONNX Runtime, так и через NCNN.
        """
        return self.azur_lane
