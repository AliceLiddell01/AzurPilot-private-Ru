"""Конфигурация пресетов фильтрации комиссий, определяющая схемы приоритетов поручений для различных сценариев.
Включает фильтры по кратчайшему времени, специализированные пресеты под чипы, кубы, ящики снаряжения и т. д.,
а также их ночные варианты и универсальные стандартные правила фильтрации."""
