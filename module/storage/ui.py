"""Модуль навигации интерфейса хранилища (склада).

Обрабатывает переключение страниц и настройку фильтров в интерфейсе склада,
включая переходы между вкладками снаряжения и материалов,
а также выбор параметров фильтрации по редкости.
"""
