"""Определение глобальных ресурсов интерфейса верфи, объявление всех сеток кнопок и экземпляров OCR.

Включает сетки аватаров кораблей, сетки счётчиков чертежей, сетку выбора серии PR,
а также цифровые OCR-распознаватели уровня разработки и уровня исследований.
"""
