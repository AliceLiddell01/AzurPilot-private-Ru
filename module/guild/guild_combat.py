"""Обработчик боёв в гильдии, наследующий базовый боевой класс и адаптированный под экраны результатов гильдейских боёв.

Обрабатывает экраны статуса боя и получения предметов в стиле Operation Siren.
"""
