"""Точка входа задачи наград гильдии, объединяющая подзадачи холла, снабжения и операций.

Выполняет переход в гильдию с главной страницы, последовательно запускает каждую подзадачу и возвращается назад.
"""
