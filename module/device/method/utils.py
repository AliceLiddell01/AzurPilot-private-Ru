"""Общие утилиты слоя методов устройства. Включают обработку ошибок ADB,
стратегии повторных попыток, разбор серийных номеров, анализ иерархии UI (HierarchyButton)
и вспомогательные функции выполнения команд shell."""
