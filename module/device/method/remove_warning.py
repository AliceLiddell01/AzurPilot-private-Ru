"""Фильтрация предупреждений ADB shell. Удаляет предупреждения компоновщика
из вывода команд shell в эмуляторах вроде VMOS, предотвращая сбои разбора данных (например, данных снимков PNG)."""
