"""Параметры конфигурации Scrcpy. Определяет параметры кодирования видео (частоту кадров, битрейт, профиль H.264 и т. д.)
и конфигурацию времени выполнения, такую как ориентация экрана."""
