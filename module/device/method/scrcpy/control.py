"""Отправитель команд управления Scrcpy. Инкапсулирует бинарное кодирование
событий ввода касаний, клавиш и их отправку по сокету; инъекция протокола выполняется декоратором inject."""
