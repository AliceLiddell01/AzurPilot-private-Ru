"""Бэкенд создания снимков экрана и управления Scrcpy. Объединяет ScrcpyCore и ControlSender,
предоставляя захват снимков с повторными попытками, нажатия касаний и операции свайпа."""
