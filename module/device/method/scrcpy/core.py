"""Основной слой соединения Scrcpy. Управляет сокет-соединениями со службой
scrcpy на стороне устройства, декодированием видеопотока, созданием каналов управления и жизненным циклом подключения."""
