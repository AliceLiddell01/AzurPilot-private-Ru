"""Логика взаимодействия с кораблями в личных покоях.

Управляет процессом взаимодействия с персонажами в личных покоях, включая навигацию в целевую комнату,
обработку диалоговых событий, нажатие кнопок взаимодействия и проверку завершения.
Поддерживает взаимодействие с несколькими кораблями (Anchorage, Noshiro, Sirius и др.).
