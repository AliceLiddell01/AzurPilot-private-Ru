"""Определение глобальных констант интерфейса выбора в магазинах, включая структуру сетки и сопоставление выбора товаров.
Определяет типы товаров, подварианты и порядок выбора для магазина гильдии и магазина медалей.
"""
