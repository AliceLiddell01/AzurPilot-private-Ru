"""Определения пресетов фильтров исследований, содержащие различные оптимизированные стратегии выбора проектов.
Предоставляет строки фильтрации под различные цели по потребности в чертежах и эффективности затрат времени.
"""
