"""Утилиты фильтра исследований: разделение, объединение и форматирование строк фильтра.
Используются для форматированного вывода и разбора пресетов исследований.
"""
...
def translate(string: str, target='series_4_tenrai_only_cube', for_simulate=False):
    ...
    if res:
        ...
        print(f'Неизвестная серия для преобразования цели: {target}')
        return
    cube = 'cube' in target
