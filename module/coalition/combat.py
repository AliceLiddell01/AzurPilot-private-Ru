"""Модуль обработки боёв в совместных операциях (Coalition Event).

Обрабатывает боевой процесс в совместных операциях, включая повторный вход в бой,
определение состояния боя, фиксацию завершения операции и др. Наследует CoalitionUI
и CampaignBase, объединяя навигацию по интерфейсу и боевую логику кампании.
"""
