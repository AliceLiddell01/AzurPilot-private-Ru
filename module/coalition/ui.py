"""Модуль обработки интерфейса совместных операций (Coalition Event).

Предоставляет функции взаимодействия с интерфейсом совместных операций, включая определение страниц,
переключение уровней сложности, подтверждение выбора этапа, подготовку боевого построения флотов
и навигацию назад. Определяет класс NeoncitySwitch для обнаружения специальных состояний с красным текстом.
"""
