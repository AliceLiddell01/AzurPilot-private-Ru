...
Распознает и подсчитывает различные выпавшие предметы со скриншотов получения предметов завершения боя,
поддерживает автоматическое обнаружение сетки предметов от 1 до 3 строк и OCR-распознавание количества.
"""
