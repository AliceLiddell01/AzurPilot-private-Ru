...
Предоставляет базовые функции загрузки шаблонов изображений, управления сеткой предметов (ItemGrid)
и сопоставления изображений, обеспечивая низкоуровневую обработку изображений для модуля статистики дропа.
"""
