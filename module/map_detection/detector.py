"""Модуль-обёртка детектора карты. Предоставляет класс MapDetector как единую точку входа
для обнаружения карты, объединяя бэкенды гомографии (Homography) и перспективного анализа (Perspective)."""
