"""Пример модуля бэкенда обнаружения карты. Демонстрирует реализацию пользовательского бэкенда
обнаружения карты с интерфейсами load/detect/set_backend для вызова из MapDetector."""
