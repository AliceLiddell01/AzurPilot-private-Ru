"""Утилиты перенаправления фильтров магазина.

Предоставляет функции наподобие bp_redirect для миграции устаревших форматов чертежей исследований
(например, PRBP, PROdinBP) в новый формат серий (PRS1, PROdinS3).
"""
