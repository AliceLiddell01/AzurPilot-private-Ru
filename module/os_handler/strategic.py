"""Обработчик стратегического поиска Операции «Сирена».

Управляет процессом взаимодействия с функцией «Стратегический поиск» (Strategic Search).
Обеспечивает вход в панель стратегического поиска, переключение вкладок (очищенные/неочищенные),
выбор параметров поиска, обработку всплывающих окон подтверждения и управление полосой прокрутки.
"""
