"""Обработчик приказов карты Операции «Сирена».

Управляет операциями приказов на карте Операции «Сирена» (вход в зону,
перемещение флота и др.), наследуя управление картой, обработку очков
действия и обработку событий карты. Обеспечивает вход и выход из панели приказов,
анализ цветов зон для определения их состояния и сопутствующие операции.
"""
import numpy as np
