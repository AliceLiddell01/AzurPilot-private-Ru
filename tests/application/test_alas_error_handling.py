...
class TestGameStuckRecovery(unittest.TestCase):
    ...
    def test_failed_game_restart_without_emulator_recovery_policy_remains_failure(self):
    ...
    def test_failed_game_restart_and_failed_emulator_recovery_is_not_recoverable(self):
        script = self._make_script(
            GameStuckError('synthetic stuck'),
            emulator_escalation=True,
        )
