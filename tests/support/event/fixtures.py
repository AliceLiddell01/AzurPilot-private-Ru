...
CURRENT_FIXTURE_ROOT = FIXTURES_ROOT / "event" / "datamine" / "current_en"
UPSTREAM_RUNTIME_AUDIT_ROOT = (
    FIXTURES_ROOT / "event" / "datamine" / "upstream_runtime_semantics"
)
...
def current_generated_package_root() -> Path:
    return (
        ...
        / "campaign"
        / "generated_event"
        / Path(*current_generated_package_parts())
    )
