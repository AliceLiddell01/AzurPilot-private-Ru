...
class Stage8ASecurityReviewTests(unittest.TestCase):
    def test_subprocess_calls_do_not_enable_shell(self):
        source = _source("dev_tools/stage8a_device_acceptance.py")
    ...
    def test_external_diagnostics_are_sanitized_before_report(self):
        main = _function_source("dev_tools/stage8a_device_acceptance.py", "main")
    ...
    def test_temporary_screenshot_is_deleted(self):
        run = _function_source("dev_tools/stage8a_device_acceptance.py", "run_acceptance")
    ...
    def test_forwarding_remains_target_scoped(self):
        run_adb = _function_source("dev_tools/stage8a_device_acceptance.py", "_run_adb")
        self.assertIn('[adb, "-s", serial, *args]', run_adb)
        close_probe = _function_source(
            "dev_tools/stage8a_device_acceptance.py", "_close_minitouch_probe"
        )
