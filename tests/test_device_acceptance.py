...
class DeviceAcceptanceTests(unittest.TestCase):
    ...
    @mock.patch("tools.acceptance.device.subprocess.run")
    ...
    @mock.patch("tools.acceptance.device._wait_for_target_device")
    @mock.patch("tools.acceptance.device._run_adb_connect")
    @mock.patch("tools.acceptance.device._run_adb")
    @mock.patch("tools.acceptance.device._confirm", return_value=True)
    ...
    @mock.patch("tools.acceptance.device._preview_dependencies")
    ...
    @mock.patch("tools.acceptance.device._new_device")
    ...
    @mock.patch("tools.acceptance.device.run_acceptance")
