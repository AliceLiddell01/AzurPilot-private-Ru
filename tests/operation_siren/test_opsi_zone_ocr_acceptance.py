...
from tools.acceptance.ocr_commission import _write_png as write_commission_png
from tools.acceptance.ocr_opsi_zone import (
...
from tools.acceptance.ocr_opsi_zone import _write_png as write_opsi_png
...
class OperationSirenZoneAcceptanceTests(unittest.TestCase):
    ...
    def test_live_runner_is_bounded_and_read_only(self) -> None:
        source = Path("tools/acceptance/ocr_opsi_zone.py").read_text(
            encoding="utf-8"
        )
