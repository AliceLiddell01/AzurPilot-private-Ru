...
Старые locale-файлы и server-specific assets остаются в репозитории как неактивные данные до отдельного Stage 9. Игровой сервер, package name, OCR-профиль и английский источник названий событий не зависят от языка WebUI. Массовая русификация эксплуатационных и игровых журналов относится к Stage 7–8.
