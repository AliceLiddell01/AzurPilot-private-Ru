 ...
 * Просмотр снимков экрана, автоматическое обновление и другие frontend-функции
 * Перенесено из runtime-инъекции app.py run_js() в статическую загрузку
 */

// ============================================================
// Автоматическое обновление (автоматический reload после разрыва соединения)
...
// ============================================================
// Просмотр снимков экрана (увеличение, масштабирование и перетаскивание по клику)
// ============================================================
(function () {
...
// ============================================================
// Предпросмотр трансляции экрана (H264 over WebSocket)
// ============================================================
(function () {
    var state = {
        socket: null,
    ...
    // Не допускаем неограниченного накопления бинарных кадров WebSocket в браузере при приостановке страницы или отставании декодирования.
    var MAX_MEDIA_QUEUE_ITEMS = 24;
    var MAX_MEDIA_QUEUE_BYTES = 12 * 1024 * 1024;
    // Для предпросмотра достаточно короткого окна истории; устаревшие сегменты необходимо активно освобождать из SourceBuffer.
    ...
    function getSocketCandidates() {
        ...
        // Точка удалённого доступа Alas обычно имеет вид /{sock_name}/..., где sock_name — не менее 8 строчных букв или цифр.
