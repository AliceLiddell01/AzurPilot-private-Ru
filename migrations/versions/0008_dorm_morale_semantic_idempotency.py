...
сохранённым хэшам нельзя. Миграция не вводит параллельный путь совместимости со
старым форматом: прежние значения остаются непрозрачными историческими ключами,
а новые записи хранят исходный ключ напрямую.
"""
