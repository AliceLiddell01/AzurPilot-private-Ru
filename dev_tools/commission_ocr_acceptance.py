...
def _json_default(value: Any):
    """Convert NumPy evidence values to native JSON-compatible objects."""
...
def _prepare_artifact_dir(path: Path) -> list[str]:
    """Remove only files generated by earlier acceptance runs."""
...
def _commission_row(comm, mode: str, row_id: int, artifact_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "row_area": [int(value) for value in comm.area],
        "name_area": [int(value) for value in comm.button.area],
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        try:
            ...
            print(
                "Commission OCR acceptance: FAIL — не удалось записать отчёт: "
