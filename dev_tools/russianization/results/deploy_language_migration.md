...
Dependency map содержит 201 evidence entries по цепочке locale/server/OCR/package/assets. Конкретные файлы и строки находятся в `locale_dependency_map.json`.
