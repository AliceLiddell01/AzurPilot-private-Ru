...
SHIP_RETIRE_COINS = {
    'dd': 12,   # Эсминец
    'cl': 14,   # Лёгкий крейсер
    'ca': 18,   # Тяжёлый крейсер
    'cb': 19,   # Большой крейсер
    'bc': 22,   # Линейный крейсер
    'bb': 26,   # Линкор
    'cvl': 16,  # Лёгкий авианосец
    'cv': 24,   # Авианосец
    'bm': 13,   # Монитор
    'ar': 13,   # Ремонтный корабль
    "ss": 24,   # Подводная лодка
}
