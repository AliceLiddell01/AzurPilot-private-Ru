...
- Более свежий PR или задача GitHub не становятся постоянным правилом автоматически.
...
- Уже подтверждённый инвариант не перечитывается после каждого малого исправления.

## Что здесь запрещено хранить

- текущий PR, ветку, SHA верхушки ветки и разовые свидетельства;
