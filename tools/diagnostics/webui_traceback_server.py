...
FIXTURE_PREFIX = "/tests/fixtures/webui/traceback/fixture-"
...
def main() -> None:
    ...
    print(
        ...
        "/tests/fixtures/webui/traceback/fixture-dark.html"
    )
    print(
        "Light: "
        f"http://{args.host}:{args.port}"
        "/tests/fixtures/webui/traceback/fixture-light.html"
    )
    try:
